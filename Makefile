main: main.o parser.o scanner.o node.o
	gcc -pedantic-errors -g lpl_parser.o lpl_scanner.o node.o main.o -o main

main.o: main.c parser.o scanner.o 
	gcc -pedantic-errors -g -c main.c -o main.o 

parser.o: lpl_parser.y 
	lemon lpl_parser.y -s
	gcc -pedantic-errors -g -c -o lpl_parser.o lpl_parser.c

node.o: node.h node.c
	gcc -pedantic-errors -g -c -o node.o node.c

scanner.o: lpl_scanner.l
	flex --outfile=lpl_scanner.c --header-file=lpl_scanner.h lpl_scanner.l
	gcc -pedantic-errors -g -c -o lpl_scanner.o lpl_scanner.c
